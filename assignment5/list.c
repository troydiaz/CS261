 ...
 */
void list_insert(struct list* list, void* val, void* key) {
  assert(list);
...
// Function to return in list is empty
...
// Function to return value of node based on given key
void* get_value(struct list* list, void* key){
  struct node* curr = list->head;
